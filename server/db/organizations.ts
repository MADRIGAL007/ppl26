...
// Import database connection utilities from main db module
let pgPool: any = null;
let sqliteDb: any = null;
let isPostgres = false;

/**
 * Initialize with database connections from main db module
 */
export function initOrgModule(pg: any, sqlite: any, usePostgres: boolean) {
    pgPool = pg;
    sqliteDb = sqlite;
